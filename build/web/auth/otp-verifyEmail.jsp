                                ...
                                <div class="card card-plain">
                                    ...
                                    <div class="card-body">                                       
                                        <div class="input-group input-group-outline mb-3">
                                            <input name="otp" id="verifyCode" type="number" class="form-control" id="floatingInput" placeholder="######">
                                        </div>
                                        <p id="fl-otp-feedback" class="error-message" style="display: none">Incorrect OTP! Try Again! </p>
                                       
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" onclick="checkOTP()">CONFIRM OTP</button>
                                        </div>
                                    </div>
